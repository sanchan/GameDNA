...
export default function SwipeControls({ onSwipe, disabled = false, onInfo }: SwipeControlsProps) {
  return (
    <div className="flex items-center justify-center space-x-4 mt-6">
      ...
      >
        <i className="fa-solid fa-xmark text-xl text-red-500 group-hover:text-white transition-colors duration-300" />
      </button>
      ...
      >
        <i className="fa-solid fa-question text-lg text-yellow-500 group-hover:text-white transition-colors duration-300" />
      </button>
      ...
      >
        <i className="fa-solid fa-heart text-2xl text-white transition-colors duration-300" />
      </button>
