  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <Link to="/" className="text-sm text-gray-400 hover:text-white transition-colors mb-4 inline-flex items-center gap-1">
            <i className="fa-solid fa-arrow-left" /> Back
          </Link>
          <h1 className="text-3xl lg:text-4xl font-bold mb-2">Legal</h1>
          <p className="text-gray-400">Privacy, terms, and third-party attributions</p>
        </div>

        {/* Steam Disclaimer */}
        <div className="bg-[#242424] border border-[#333] rounded-2xl p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
            <i className="fa-brands fa-steam text-gray-400" />
        ...
        <div className="bg-[#242424] border border-[#333] rounded-2xl p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
            <i className="fa-solid fa-shield-halved text-gray-400" />
            Privacy Policy
          </h2>
          <div className="space-y-4 text-sm text-gray-300 leading-relaxed">
            <section>
              <h3 className="font-semibold text-white mb-1">What data we collect</h3>
              <p>
            ...
            <section>
              <h3 className="font-semibold text-white mb-1">How we use your data</h3>
            ...
            <section>
              <h3 className="font-semibold text-white mb-1">Data export & deletion</h3>
              <p>
            ...
            <section>
              <h3 className="font-semibold text-white mb-1">Cookies & tracking</h3>
              <p>
        ...
        <div className="bg-[#242424] border border-[#333] rounded-2xl p-6 mb-6">
          <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
            <i className="fa-solid fa-file-contract text-gray-400" />
            Terms of Use
          </h2>
          <div className="space-y-4 text-sm text-gray-300 leading-relaxed">
            <section>
              <h3 className="font-semibold text-white mb-1">Acceptance</h3>
              <p>
            ...
            <section>
              <h3 className="font-semibold text-white mb-1">Service description</h3>
              <p>
