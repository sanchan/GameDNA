    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-[var(--text-muted)]">{t('help.privacyDesc')}</p>
        </div>
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 mb-6">
          ...
          <div className="space-y-4">
            {principles.map((p) => (
              <div key={p.titleKey} className="flex items-start gap-4 bg-[var(--background)] rounded-xl p-4">
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 mb-6">
          ...
          <div className="space-y-4 text-sm text-[var(--text-body)] leading-relaxed">
            <div>
              <h3 className="font-semibold text-[var(--foreground)] mb-2">{t('helpPrivacy.weAccess')}</h3>
              <ul className="list-disc list-inside space-y-1 ml-2 text-[var(--text-muted)]">
            ...
            <div>
              <h3 className="font-semibold text-[var(--foreground)] mb-2">{t('helpPrivacy.weNeverAccess')}</h3>
              <ul className="list-disc list-inside space-y-1 ml-2 text-[var(--text-muted)]">
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 mb-6">
          ...
          <Link
            to="/settings"
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-[var(--background)] border border-[var(--border)] text-[var(--text-body)] rounded-xl text-sm font-medium hover:border-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors"
          >
